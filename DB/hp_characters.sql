...
INSERT INTO `hp_characters` (`id`, `first_name`, `last_name`, `description`, `type`, `gender`, `house`, `number_of_books`, `dead`, `death_eater`, `trivia`, `image_link`) VALUES (6, 'Hermione', 'Granger', 'Smartest in Harry\'s year and one of his two best friends', 'Human', 0, 'Gryffindore', 7, 0, 0, 'She is the first of her age to cast non-verbal spells.', 'https://i.pinimg.com/236x/70/6a/8d/706a8d72fd3b0e405588abcbb2a604ca--best-sleep-night-parties.jpg');
INSERT INTO `hp_characters` (`id`, `first_name`, `last_name`, `description`, `type`, `gender`, `house`, `number_of_books`, `dead`, `death_eater`, `trivia`, `image_link`) VALUES (7, 'Rubeus', 'Hagrid', 'Half-Giant and Gameskeeper for Hogwarts who loves Magical Creatures', 'Half-Giant', 1, 'Gryffindore', 7, 0, 0, 'After being expelled from Hogwarts, the Ministry destroys his wand which Hagrid keeps in an umbrella to perform small spells.', 'https://cdna.artstation.com/p/assets/images/images/004/316/118/large/nicolas-morales-challenge-hagrid-final.jpg?1482348300');
